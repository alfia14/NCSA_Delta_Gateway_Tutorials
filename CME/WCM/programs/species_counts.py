...
class SpeciesCounts():
        ...
        """
        def getSpeciesCountView(self, solver):
        ...
        # The getter and setter is just for convenient operation
        """
        ...
        def __getitem__(self,key):
                ...
                return self.count_array[idx] # the returned value is in data type (numpy.uint32)
